...
class TensorNameMap:
    ...
    block_mappings_cfg: dict[MODEL_TENSOR, tuple[str, ...]] = {
        ...
        MODEL_TENSOR.ATTN_Q_S_A: (
            "model.layers.{bid}.self_attn.q_proj.in_channel_scale",
        ),
        MODEL_TENSOR.ATTN_Q_S_B: (
            "model.layers.{bid}.self_attn.q_proj.out_channel_scale",
        ),
        MODEL_TENSOR.ATTN_Q_S_C: (
            "model.layers.{bid}.self_attn.q_proj.gate_linear",
        ),
        MODEL_TENSOR.ATTN_K_S_A: (
            "model.layers.{bid}.self_attn.k_proj.in_channel_scale",
        ),
        MODEL_TENSOR.ATTN_K_S_B: (
            "model.layers.{bid}.self_attn.k_proj.out_channel_scale",
        ),
        MODEL_TENSOR.ATTN_K_S_C: (
            "model.layers.{bid}.self_attn.k_proj.gate_linear",
        ),
        MODEL_TENSOR.ATTN_V_S_A: (
            "model.layers.{bid}.self_attn.v_proj.in_channel_scale",         #binarymos
        ),
        MODEL_TENSOR.ATTN_V_S_B: (
            "model.layers.{bid}.self_attn.v_proj.out_channel_scale",        #binarymos
        ),
        MODEL_TENSOR.ATTN_V_S_C: (
            "model.layers.{bid}.self_attn.v_proj.gate_linear",              #binarymos
        ),
        MODEL_TENSOR.ATTN_OUT_S_A: (
            "model.layers.{bid}.self_attn.o_proj.in_channel_scale",              #binarymos
        ),
        MODEL_TENSOR.ATTN_OUT_S_B: (
            "model.layers.{bid}.self_attn.o_proj.out_channel_scale",              #binarymos
        ),
        MODEL_TENSOR.ATTN_OUT_S_C: (
            "model.layers.{bid}.self_attn.o_proj.gate_linear",              #binarymos
        ),
        MODEL_TENSOR.FFN_GATE_S_A: (
            "model.layers.{bid}.mlp.gate_proj.in_channel_scale",         #binarymos
        ),
        MODEL_TENSOR.FFN_GATE_S_B: (
            "model.layers.{bid}.mlp.gate_proj.out_channel_scale",        #binarymos
        ),
        MODEL_TENSOR.FFN_GATE_S_C: (
            "model.layers.{bid}.mlp.gate_proj.gate_linear",              #binarymos
        ),
        MODEL_TENSOR.FFN_UP_S_A: (
            "model.layers.{bid}.mlp.up_proj.in_channel_scale",         #binarymos
        ),
        MODEL_TENSOR.FFN_UP_S_B: (
            "model.layers.{bid}.mlp.up_proj.out_channel_scale",        #binarymos
        ),
        MODEL_TENSOR.FFN_UP_S_C: (
            "model.layers.{bid}.mlp.up_proj.gate_linear",              #binarymos
        ),
        MODEL_TENSOR.FFN_DOWN_S_A: (
            "model.layers.{bid}.mlp.down_proj.in_channel_scale",         #binarymos
        ),
        MODEL_TENSOR.FFN_DOWN_S_B: (
            "model.layers.{bid}.mlp.down_proj.out_channel_scale",        #binarymos
        ),
        MODEL_TENSOR.FFN_DOWN_S_C: (
            "model.layers.{bid}.mlp.down_proj.gate_linear",              #binarymos
        ),
