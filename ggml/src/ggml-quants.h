...
void ggml_vec_dot_q1a_i8_s   (int n, float * s, size_t bs, const void * vx, size_t bx, const void * vy, size_t by, int nrc);
...
size_t quantize_q1a(const float * src, void * dst, int64_t nrow, int64_t n_per_row, const float * quant_weights);
